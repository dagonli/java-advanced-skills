...
public class DeleteFeature {
    ...
    //构造函数,为成员变量赋值
    public DeleteFeature(String requestUrl,String APPID,String apiSecret,String apiKey,String voicePrintId){
    ...
    //提供给主函数调用的方法
    public static void doDeleteFeature(String requestUrl,String APPID,String apiSecret,String apiKey,String voicePrintId) {
        DeleteFeature deleteFeature = new DeleteFeature(requestUrl, APPID, apiSecret, apiKey,voicePrintId);
        try {
