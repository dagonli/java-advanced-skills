...
public class SearchOneFeature {
    ...
    //提供给主函数调用的方法
    public static JSONObject doSearchOneFeature(String requestUrl,String APPID,String apiSecret,String apiKey,String AUDIO_PATH,String featureId) {
     ...
     * @throws Exception 异常
     */
    private String doRequest(String featureId) throws Exception {
...
//        in.close();
        ...
        byte[] wavData = Files.readAllBytes(new File("D:\\diyProject\\java-advanced-skills\\audio_compare_demo\\src\\main\\resources\\files\\李豫1.wav").toPath());
        byte[] bytes = null;
